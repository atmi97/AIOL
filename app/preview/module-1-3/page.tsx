...
/* Spot-the-error: click suspicious text spans in a scenario */
    ...
    <div className="mt-5 space-y-4">
      <div className="rounded-xl bg-gradient-to-br from-brand-600 to-brand-800 text-white px-5 py-4 flex items-center justify-between flex-wrap gap-3">
        <div className="text-sm">
          <span className="font-semibold">Scenario A</span> — AI-drafted financial summary.
          Click the parts that look suspicious.
        </div>
        ...
        <div className="space-y-2">
          {SCENARIO_A.map((s, i) =>
            found[i] && s.why ? (
              <div
                key={i}
                className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-xs text-emerald-900"
              >
  ...
  return (
    ...
    >
      <Section id="hallucinations" n="1.3.1" title="Hallucinations">
        ...
        <div className="mt-6">
          <div className="text-[11px] font-semibold uppercase tracking-wider text-slate-500 mb-2">
            What hallucinations look like in AMS
          </div>
          <Accordion
            defaultOpen={null}
            items={[
          ...
          items={[
            {
              ...
              front: "Generative AI is notoriously inconsistent at arithmetic.",
              back: "It can correctly restate a policy but incorrectly add a column. 'The AI did the math' is never sufficient audit explanation on payroll or invoices. If numbers matter, verify them.",
            },
            {
              title: "Formatting errors",
              front: "Invents authoritative-looking structure that doesn't match the source.",
              back: "A tidy three-bullet recap of a 40-page policy can hide material nuance. Accurate in what it includes — misleading in what it leaves out.",
            },
            {
              title: "Staleness",
              front: "Models have a training cutoff. Past that date they know nothing.",
              back: "Ask about a 2026 HIPA amendment when the model stops in 2024: it either admits uncertainty (good) or produces plausible content anyway (not good). Tenant-connected Copilot has the same issue during synthesis.",
            },
            {
              title: "Context window limits",
              front: "AI has finite input it can consider at once.",
              back: "Feed a 200-page doc into a 40-page tool and the model may quietly drop content from the middle. The output will still look complete.",
            },
            {
              title: "Prompt sensitivity",
              front: "Same question, different phrasing → different answer.",
              back: "'Summarize this invoice' and 'List the key points of this invoice' may emphasize different fields. Not a bug — a property. Reason to be cautious about treating any single output as definitive.",
            },
          ]}
        />
      </Section>
      ...
      <Section id="spot" n="1.3.5" title="Activity: Spot the hallucination">
        <p>
          Below is an AI-drafted executive summary of Q2 2026 financial performance. It contains four deliberately planted errors. Click any part of the text that looks suspicious.
        </p>
        <SpotTheError />
      </Section>
