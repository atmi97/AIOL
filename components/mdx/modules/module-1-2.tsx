...
const TIERS = [
  ...
  { k: "2", name: "Practitioner", audience: "Daily AI users — analysts, service desk, devs", unlocks: "Role-specific approved tools", renewal: "Annual" },
  { k: "3", name: "Champion", audience: "Team leads and managers", unlocks: "All approved + admin surfaces", renewal: "Biannual" },
  { k: "4", name: "Governance", audience: "AMS leadership, Steering Committee reps", unlocks: "Full + governance + configuration", renewal: "Biannual" },
];
        ...
        {TIERS.filter((t) => t.k === active).map((t) => (
          <div key={t.k} className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="px-3 py-1 rounded-full bg-brand-600 text-white text-xs font-semibold">Tier {t.k}</div>
  ...
  return (
    <>
          ...
          items={[
            {
              ...
              body: (
                <>
                  <p>Oracle has embedded AI agents across Finance, Procurement, and HCM. They draft narratives, propose purchase requisition corrections, flag anomalies, and assist HR with case summaries.</p>
            ...
            },
            {
              ...
              body: (
                <>
                  <p>Copilot operates inside the 3sHealth Microsoft tenant — with your permissions — across Word, Excel, PowerPoint, Outlook, and Teams. It does not expose tenant content to the public internet.</p>
                  <p>But it will happily summarize PHI that sits in an Outlook thread. The summary inherits the sensitivity of the source.</p>
            ...
            },
            {
              ...
              body: (
                <>
                  <p>Virtual Agent for self-service, AI-powered routing, Now Assist for agent-facing summaries, Predictive Intelligence for incident grouping.</p>
      ...
      <Section id="your-role" n="1.2.6" title="Your role">
        <p>The AUP is explicit: every AMS team member who uses AI is personally responsible for safe, lawful, ethical, and policy-compliant use.</p>
